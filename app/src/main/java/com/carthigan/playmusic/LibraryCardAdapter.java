...
public class LibraryCardAdapter extends RecyclerView.Adapter<LibraryCardAdapter.CardViewHolder> {
    ...
    public LibraryCardAdapter(OnItemClickListener clickListener) {
